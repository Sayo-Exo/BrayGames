!function () {
  ...
  let c = a("q") || a("p");
  o = c && -1 !== c.indexOf("Rooftop Snipers Unblocked".toLowerCase()), chrome.runtime.sendMessage({message: {r: t}}, function (e) {
    if (null != e) try {
    ...
    t.className = "game-button-box", t.innerHTML = '<div class="game-button-icon-box"></div><div class="game-button-section"><div class="game-button-title">Rooftop Snipers Unblocked</div><div class="game-button-installed"><img src="' + chrome.runtime.getURL("images/installed.svg") + '" alt="" width="27" height="27">' + chrome.i18n.getMessage("installed") + "</div></div>";
    let n = function (n) {
